...
============================= petacat test matrix ==============================
  ...
  e2e            225 collected    225 run    225 passed      0 failed      0 skipped  complete
...
| **e2e** | `tests/e2e/` | Full HTTP API + persistence | Local PostgreSQL (`petacat_test`) | 225 |
...
six actually run: **2,198 cases**, every one of them executed. A layer that is
...
| `test_step0_config_from_db.py` | 16 | Step 0's guard tests: a shipped value reproduces the run and a changed one moves it |
