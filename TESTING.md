...
============================= petacat test matrix ==============================
  ...
  e2e            252 collected    252 run    252 passed      0 failed      0 skipped  complete
...
| **e2e** | `tests/e2e/` | Full HTTP API + persistence | Local PostgreSQL (`petacat_test`) | 252 |
...
six actually run: **2,234 cases**, every one of them executed. A layer that is
...
| `test_step0_config_from_db.py` | 43 | Step 0's guard tests: a shipped value reproduces the run and a changed one moves it |
