...
============================= petacat test matrix ==============================
  ...
  e2e            234 collected    234 run    234 passed      0 failed      0 skipped  complete
...
| **e2e** | `tests/e2e/` | Full HTTP API + persistence | Local PostgreSQL (`petacat_test`) | 234 |
...
| `test_step0_config_from_db.py` | 25 | Step 0's guard tests: a shipped value reproduces the run and a changed one moves it |
