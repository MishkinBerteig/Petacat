...
============================= petacat test matrix ==============================
  ...
  e2e            243 collected    243 run    243 passed      0 failed      0 skipped  complete
...
| **e2e** | `tests/e2e/` | Full HTTP API + persistence | Local PostgreSQL (`petacat_test`) | 243 |
...
| `test_step0_config_from_db.py` | 34 | Step 0's guard tests: a shipped value reproduces the run and a changed one moves it |
