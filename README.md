...
> a different answer each time. It ships with 2,192 test cases covering the engine, the API, and the
...
- **Backend** (`tests/`) — Python / pytest. Covers the engine, the API, the
  ...
  the local Postgres — 2,192 cases, which includes the numeric matrix's second
